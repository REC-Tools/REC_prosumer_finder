...
(
  nw["power"="generator"]["generator:source"="solar"];
  nw["power"="generator"]["generator:method"="photovoltaic"];
  nw["power"="plant"]["plant:source"="solar"];
  nw["power"="plant"]["plant:method"="photovoltaic"];
  nw["generator:source"="solar"];
  nw["generator:method"="photovoltaic"];
  nw["solar"="photovoltaic"];
  nw["roof:material"="solar_panels"];
);
out body center qt;
`;
}
